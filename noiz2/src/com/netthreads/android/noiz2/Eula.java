...
public class Eula
{
    ...
    static boolean show(final Activity activity)
    {
        ...
        if (!preferences.getBoolean(PREFERENCE_EULA_ACCEPTED, false))
        {
            ...
            builder.setMessage(FileHelper.readAsset(ASSET_EULA, activity));
            builder.create().show();
    ...
    /**
     * Helper method to get agreement setting.
     * 
     * @param context
     * 
     * @return agreement flag
     */
    public static boolean isAgreedTo(Context context)
    {
        final SharedPreferences preferences = context.getSharedPreferences(PREFERENCES_EULA, Activity.MODE_PRIVATE);

        return preferences.getBoolean(PREFERENCE_EULA_ACCEPTED, false);
    }
    
    /**
     * A callback to let the activity know when the user has accepted the EULA.
     */
